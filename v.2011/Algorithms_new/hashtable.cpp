...
class fstring {
public:
	static const int MAX_LENGTH=80; // максимальна€ длина строки
	static char delimiter; // разделитель
	static char nonSymbol; // символ, который не встречаетс€ в строках
...
public:
	...
	valuetype &operator[](keytype key); // примен€ть только после get
};
